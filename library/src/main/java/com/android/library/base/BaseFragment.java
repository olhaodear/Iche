...
/**
 * Created by dugang on 2015/10/09. Fragment父类
 */
public abstract class BaseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflaterLayoutView(inflater, container, savedInstanceState);
     ...
     * 加载布局文件
     */
    protected abstract View inflaterLayoutView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState);
